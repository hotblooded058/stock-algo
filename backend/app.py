...
from backend.routes import market, signals, trades, options, system, backtest, journal, alerts, screener, paper
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # Allow all origins (phone, tablet, other devices)
